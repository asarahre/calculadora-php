...
<body class="bg-slate-800 h-screen w-screen">
  <form action="" method="get" class="h-full w-full">
    <div class="grid grid-cols-3 gap-4 place-content-center h-full mx-8">
      <div class="">
        <label for="n1" class="block mb-2 text-sm font-medium text-gray-900 text-gray-300">Primeiro Número</label>
        <input type="number" id="n1" value="0" name="n1" aria-describedby="helper-text-explanation"
      ...
      <div>
        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 text-gray-400">Escolha uma
          opeção</label>
        <select id="op" name="op" value="+"
          class="text-slate-400 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
      ...
      <div>
        <label for="n2" class="block mb-2 text-sm font-medium text-gray-900 text-gray-300">Segundo Número</label>
        <input type="number" value="0" id="n2" name="n2" aria-describedby="helper-text-explanation"
          class="text-slate-400 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" />
      </div>
      <div class="">
        <div
